...
namespace Negocio
{
    public class clsFunciones
    {
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = "Nombre";   // agrega lineas de  encabezados
            ...
            {
                if (cant.ToString().Length <= 10 && precio.ToString("c").Length <= 100 && subtotal.ToString("c").Length <= 110) // valida que cant precio y total esten dentro de rango
                {
                    string elementos = "", espacios = "", elementos1 = "",  elementos2 = "" ,  elementos3 = "";
                    bool bandera = false;
                    int nroEspacios = 0;
                    ...
                    else
                    {
                        ...
                        line.AppendLine(LineEncavesado1);
                        line.AppendLine(elementos1);
                        string LineEncavesado2 = "P.Unit";   // agrega lineas de  encabezados
                        line.AppendLine(LineEncavesado2);
                        line.AppendLine(elementos2);
                        string LineEncavesado3 = "Valor";   // agrega lineas de  encabezados
                        line.AppendLine(LineEncavesado3);
                        line.AppendLine(elementos3);
